...
export function correctOpenRangeSQL(sql: string, payload: IDataQueryPayload): string {
...
export function compileWorkflowToSQL(
    parser: (tableName: string, payload: string) => string,
    tableName: string,
