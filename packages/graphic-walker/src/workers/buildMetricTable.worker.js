 ...
 */
const main = e => {
    const { dimsInRow, dimsInColumn, allData, aggData, collapsedKeyList, showTableSummary, sort, rollupMeasures } = e.data;
    try {
        const ans = buildPivotTable(dimsInRow, dimsInColumn, allData, aggData, collapsedKeyList, showTableSummary, sort, rollupMeasures);
